...
pub const Runtime = struct {
    ...
    pub const canvasViewHasHybridLayers = CanvasFrameMethods.canvasViewHasHybridLayers;
    pub const presentNextCanvasHybridPacket = CanvasFrameMethods.presentNextCanvasHybridPacket;
