...
pub const CapturePendingWork = runtime.CapturePendingWork;
...
pub const NullTimer = platform.NullTimer;
pub const NullGpuSurfaceFrameRequest = platform.NullGpuSurfaceFrameRequest;
pub const max_null_timers = platform.max_null_timers;
pub const WindowId = platform.WindowId;
pub const WindowOptions = platform.WindowOptions;
pub const PrimaryDisplayAnchorCorner = platform.PrimaryDisplayAnchorCorner;
pub const PrimaryDisplayAnchor = platform.PrimaryDisplayAnchor;
...
pub const WindowLayer = platform.WindowLayer;
